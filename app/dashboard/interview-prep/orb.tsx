...
export default function Orb({
  ...
  const frag = /* glsl */ `
    ...
    const vec3 baseColor1 = vec3(0.4, 0.8, 1.0);
    const vec3 baseColor2 = vec3(0.8, 0.3, 1.0);
    const vec3 baseColor3 = vec3(0.1, 0.2, 0.9);
    ...
    vec4 draw(vec2 uv) {
      ...
      float r0 = mix(mix(innerRadius, 1.0, 0.45), mix(innerRadius, 1.0, 0.65), n0);
      float d0 = distance(uv, (r0 * invLen) * uv);
      float v0 = light1(1.2, 12.0, d0);
      ...
      float v1 = light2(2.0, 6.0, d);
      v1 *= light1(1.2, 45.0, d0);
